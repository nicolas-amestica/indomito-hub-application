...
import { FAVORITES_AVAILABLE } from '../../config/favorites-availability.token';
...
import { ExchangeRateStore } from '../../state/exchange-rate.store';
import { FavoritesStore } from '../../state/favorites.store';
import { ProgramFormStore } from '../../state/program-form.store';
