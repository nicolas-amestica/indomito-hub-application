...
<!-- Generated by: sync-context.sh v1.0.0 at 2026-08-09T05:15:13.998Z -->
...
- **Arquitectura**: multi-repo con orquestador centralizado (`ind-hub-orc`)
- **Repos**: `ind-hub-app` (Angular), `ind-hub-api` (Go microservicios), `ind-hub-inf` (Infraestructura AWS)
...
| ----------- | --------------------------- | --------------------- |
| ind-hub-app | `src/app/` (por definir)    | Stores, servicios     |
| ind-hub-api | `services/api-auth/`        | Endpoint-per-function |
...
| Repo        | Scopes                                                                                   |
| ----------- | ---------------------------------------------------------------------------------------- |
| ind-hub-inf | `ddb`, `s3`, `ssm`, `cdn`, `waf`, `iot`, `config`, `deps`                               |
| ind-hub-app | `core`, `app-auth`, `accounting`, `analytics`, `assign-installment`, `shared`, `client`, `configuration`, `documents`, `help`, `home`, `inbox`, `informative-media`, `layout`, `meet`, `passenger`, `payment`, `payment-history`, `profile`, `program`, `ticket`, `tools` |
| ind-hub-api | `accounting`, `balance`, `configuration`, `contract`, `entity`, `extraction`, `favorites`, `maintainer`, `meet`, `notification`, `payment`, `program`, `ticket`, `tools`, `whatsapp-agent`, `authorizer`, `trigger`, `config`, `deps` |
| ind-hub-orc | `docs`, `tools`, `steering`, `workspace`, `config`                                       |
