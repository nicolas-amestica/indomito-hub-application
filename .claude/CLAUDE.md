...
<!-- Generated by: sync-context.sh v1.0.0 at 2026-08-30T19:10:53.325Z -->
...
- Auth: JWT custom (autenticador propio, `iam-auth` — Lambda Authorizer del HTTP API Gateway compartido)
