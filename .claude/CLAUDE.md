...
# CLAUDE.md — ind-hub-app

> Contexto generado automaticamente para Claude en ind-hub-app-ngx-pri-gh.
...
Los siguientes archivos contienen estandares detallados. Consultalos cuando necesites contexto adicional:
...
- `docs/standards/architecture/legacy-systems.md`
